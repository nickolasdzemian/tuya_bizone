...
* выполнен рефакторинг меню настроек кнопок - данные отправляются только по нажатию кнопки сохранить
* исправлена ошибка, вызывающая отправку неверных (инвертированных) данных при быстром переключении температуры поддержания на главном экране
* исправлена ошибка, вызывающая отправку неверных (инвертированных) данных при быстром переключении питания поддержания на главном экране -->

#### 3.4.2
* iOS -- добавлен тактильный отклик для компонентов (+15)
* добавлена возможность переключения зон при помощи свайпа (для маленьких экранов)
* добавлено переопределение статусбара (Android)
* выполнена адаптация компонентов Tuya Design под обновленные данные
* исправлена плавающая ошибка, которая могла вызывать некорректное отображение данных в разделе Подробно Статистики (key extractor)
* исправлена, которая могла вызывать перекрестную обработку жестов (panel, slider, swipable, toggleable)
* исправлено отображение цветов статусбара при переключении системной темы
* исправлено отображение верхних (максимальных) значений в графиках статистики

#### 3.4.0+

* улучшена производительность
* добавлен программируемый таймер для вентилятора в режиме климат-контроля
* добавлен компонент, позволяющий работать со состояниями внутри структуры приложения не используя основное дерево
...
* добавлены переводы в меню сценариев и автоматизации
* добавлена возможность удаления имени зоны (длительным нажатием на пункт меню)
* добавлены быстрые настройки на главном экране списка устройств
* обновлено меню автоматизации в соответсвии с поддерживаемыми dp
* обновлена анимация закрытия диалогового окна для ввода текста
* обновлен внешний вид контекстного меню Опции во всех программных режимах
* обновлено отображение placeholder в меню переименования зон
* исправлены отступы контекстного меню Опции во всех программных режимах
* исправлены выравнивания текста в настройках глобального режима
* исправлена ошибка, которая не давала моментально применяться настройкам:
  - скрыть зоны с главного экрана
  - переименование зоны
* исправлена ошибка перезаписи состояния во временном хранилище
