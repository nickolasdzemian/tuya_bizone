export default {
  ...
  // Общие
  // Секретный режим Рождественского чуда и праздника пришествия бога нашего Иисуса Христа на нашу землю
  Christ: 'christ_mode',
  ...
  // Выбор канала охлажд. нагрева
  chSelector: 'ch_selector',
