...
// class ChartTime1 extends PureComponent {
//   constructor(props) {
//     super(props);
...
//     DATA.splice(id, 1, {
//       id,
//       temperature: temp === undefined ? '00' : temp,
//       time,
//       day,
//     });
//     this.setState({apl: true});
...
//           }}
//         >
//           <TYText style={styles.deletet}>{Strings.getLang('allpointdelTYText')}</TYText>
//         </View>
//       ),
...
//             cache.set('temp', String(stepperValue))}
//         >
...
//         >
//           <FontAwesomeIcon icon={faPlus} color={G >= 336 || A === true ? '#d6d6d6' : '#ffb700'} size={20} />
...
//                       }}
//                     >
//                       <FontAwesomeIcon icon={faCopy} color="#ffb700" size={20} />
...
//           }}
//         >
//           <FontAwesomeIcon icon={faCogs} color={(G === 0 && L === 0) || A === true ? '#d6d6d6' : '#ffb700'} size={20} />
...
//         <ActivityIndicator color="#ffb700" /> 
//       </View>
//     );
...
//           velocityThreshold={1}
//           activeColor={A === true ? '#d6d6d6' : '#ffb700'}
