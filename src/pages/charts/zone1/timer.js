...
class ChartTime1 extends Component {
  constructor(props) {
    super(props);
  ...
  _add0point() {
    this.setState({stepperValue: '00', timeSelectionValue: 366});
    const day = this.state.activeKey;
  ...
  render() {
    ...
    const ADDPOINT = (
      <View style={styles.edit}>
        ...
        >
          {G !== 0 && dayDATA.length !== 0 ? <FontAwesomeIcon icon={faCogs} color="#ffb700" size={20} />
    ...
    const Item = ({ id, title, subTitle, day }) => (
      ...
      >
        <View style={styles.inside}>
          ...
          <FontAwesomeIcon icon={faPowerOff} color="#474747" size={18} />
