...
class ChartTime2 extends Component {
  ...
  _add0point() {
    ...
    TYDevice.putDeviceData({
      [chart_2_part_1Code]: String(L + part1),
    });
    TYDevice.putDeviceData({
      [chart_2_part_2Code]: '000100',
    });
    TYDevice.putDeviceData({
      [chart_2_part_3Code]: '000100',
    });
    TYDevice.putDeviceData({
      [chart_2_part_4Code]: '000100',
    });
  } 
  ...
  render() {
    ...
    const ADDPOINT = (
      <View style={styles.edit}>
        ...
        >
          {G !== 0 && dayDATA.length !== 0 ? <FontAwesomeIcon icon={faCogs} color="#ff7300" size={20} />
