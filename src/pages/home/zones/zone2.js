  ...
  onPressMode = () => {
    ...
    Popup.list({
      ...
      dataSource: [
        ...
        // Режим программного таймера - выключен по требованию
        // {
        //   key: '02',
    ...
    Popup.countdown(
      {
        title: ttimer,
        subTitle: (
          <TYText style={{ color: '#ff7300', fontSize: 14 }} onPress={() => this.resetT()}>
      ...
      <SafeAreaView style={styles.container}>
        <View>
          ...
          >
            ...
            <TYText style={{ fontSize: 20, color: '#ff7300' }}>{this.state.name}</TYText>
            <FontAwesomeIcon
            ...
            >
              <View style={styles.areaContols}>
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faStopwatch}
                    color={C === '01' && modeZ === '00' ? '#ff7300' : '#d6d6d6'}
                    size={30}
                    margin={5}
                  />
                </TouchableOpacity>
